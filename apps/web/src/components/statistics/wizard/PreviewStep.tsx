...
export const PreviewStep: React.FC<PreviewStepProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Aperçu des données (si disponible) */}
      {previewData && (
        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
          <h4 className="text-sm font-medium text-indigo-900 mb-3">📊 Aperçu des données générées</h4>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div className="text-center">
              <div className="text-lg font-bold text-indigo-600">{previewData.summary.totalDataPoints}</div>
              <div className="text-indigo-800">Points de données</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-indigo-600">
                {previewData.statistics.global?.average?.toFixed(1) || 'N/A'}
              </div>
              <div className="text-indigo-800">Moyenne</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-indigo-600">{previewData.insights.length}</div>
              <div className="text-indigo-800">Insights</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-indigo-600">{previewData.summary.processingTime}ms</div>
              <div className="text-indigo-800">Temps calcul</div>
            </div>
          </div>
        </div>
      )}
