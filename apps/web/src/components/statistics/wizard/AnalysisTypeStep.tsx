...
const ANALYSIS_TYPES: Array<{
  ...
  {
    type: 'comparative' as CalculationType,
...
/**
 * Props du composant AnalysisTypeStep
 */
 ...
 */
export const AnalysisTypeStep: React.FC<AnalysisTypeStepProps> = ({
  data,
  validationErrors,
  onDataChange
}) => {
  ...
  const updateCalculations = React.useCallback((updates: Partial<typeof data.calculations>) => {
    onDataChange({
      calculations: {
        ...data.calculations,
        ...updates
  ...
  }, [data.calculations, onDataChange]);
